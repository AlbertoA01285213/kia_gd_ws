...
class TcpTrayectoriaNode(Node):
    def __init__(self):
        ...
        self.marker = Marker()
        self.marker.header.frame_id = "world"   # Se actualizará dinámicamente
        self.marker.ns = "tcp_path"
        self.marker.id = 0
        self.marker.type = Marker.POINTS
        self.marker.action = Marker.ADD

        # Para POINTS, estas escalas deben ser iguales
        ...
        self.marker.lifetime = Duration()  # infinito
        self.marker.points = []            # lista vacía
