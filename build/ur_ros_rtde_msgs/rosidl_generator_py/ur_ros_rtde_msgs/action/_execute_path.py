    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.ExecutePath_Goal')
            logger.debug(
...
class ExecutePath_Goal(metaclass=Metaclass_ExecutePath_Goal):
    ...
    _fields_and_field_types = {
        'waypoints': 'sequence<ur_ros_rtde_msgs/Vector>',
        'speed': 'sequence<double>',
        'acceleration': 'sequence<double>',
        'blend': 'sequence<double>',
        'move_type': 'sequence<string>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.speed = array.array('d', kwargs.get('speed', []))
        self.acceleration = array.array('d', kwargs.get('acceleration', []))
        self.blend = array.array('d', kwargs.get('blend', []))
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'waypoints' field must be a set or sequence and each value of type 'Vector'"
    ...
    def speed(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'speed' array.array() must have the type code of 'd'"
            self._speed = value
            return
        if __debug__:
            from collections.abc import Sequence
        ...
        self._speed = array.array('d', value)
    ...
    def blend(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'blend' array.array() must have the type code of 'd'"
            self._blend = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'blend' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._blend = array.array('d', value)
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'move_type' field must be a set or sequence and each value of type 'str'"
...
class Metaclass_ExecutePath_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.ExecutePath_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_ExecutePath_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.ExecutePath_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_ExecutePath_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ur_ros_rtde_msgs.action import ExecutePath
...
class ExecutePath_SendGoal_Request(metaclass=Metaclass_ExecutePath_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'ur_ros_rtde_msgs/ExecutePath_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ur_ros_rtde_msgs', 'action'], 'ExecutePath_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ur_ros_rtde_msgs.action._execute_path import ExecutePath_Goal
...
class Metaclass_ExecutePath_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.ExecutePath_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ur_ros_rtde_msgs.action import _execute_path
...
class ExecutePath_SendGoal(metaclass=Metaclass_ExecutePath_SendGoal):
    from ur_ros_rtde_msgs.action._execute_path import ExecutePath_SendGoal_Request as Request
    from ur_ros_rtde_msgs.action._execute_path import ExecutePath_SendGoal_Response as Response
...
class ExecutePath_GetResult_Response(metaclass=Metaclass_ExecutePath_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'ur_ros_rtde_msgs/ExecutePath_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ur_ros_rtde_msgs', 'action'], 'ExecutePath_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ur_ros_rtde_msgs.action._execute_path import ExecutePath_Result
...
class Metaclass_ExecutePath_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.ExecutePath_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecutePath_GetResult(metaclass=Metaclass_ExecutePath_GetResult):
    from ur_ros_rtde_msgs.action._execute_path import ExecutePath_GetResult_Request as Request
    from ur_ros_rtde_msgs.action._execute_path import ExecutePath_GetResult_Response as Response
...
class Metaclass_ExecutePath_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.ExecutePath_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecutePath_FeedbackMessage(metaclass=Metaclass_ExecutePath_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'ur_ros_rtde_msgs/ExecutePath_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ur_ros_rtde_msgs', 'action'], 'ExecutePath_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from ur_ros_rtde_msgs.action._execute_path import ExecutePath_Feedback
...
class Metaclass_ExecutePath(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.ExecutePath')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecutePath(metaclass=Metaclass_ExecutePath):
    ...
    from ur_ros_rtde_msgs.action._execute_path import ExecutePath_Goal as Goal
    # The result message defined in the action definition.
    from ur_ros_rtde_msgs.action._execute_path import ExecutePath_Result as Result
    # The feedback message defined in the action definition.
    from ur_ros_rtde_msgs.action._execute_path import ExecutePath_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from ur_ros_rtde_msgs.action._execute_path import ExecutePath_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from ur_ros_rtde_msgs.action._execute_path import ExecutePath_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from ur_ros_rtde_msgs.action._execute_path import ExecutePath_FeedbackMessage as FeedbackMessage
