    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.MoveL_Goal')
            logger.debug(
...
class Metaclass_MoveL_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.MoveL_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveL_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.MoveL_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveL_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ur_ros_rtde_msgs.action import MoveL
...
class MoveL_SendGoal_Request(metaclass=Metaclass_MoveL_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'ur_ros_rtde_msgs/MoveL_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ur_ros_rtde_msgs', 'action'], 'MoveL_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ur_ros_rtde_msgs.action._move_l import MoveL_Goal
...
class Metaclass_MoveL_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.MoveL_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ur_ros_rtde_msgs.action import _move_l
...
class MoveL_SendGoal(metaclass=Metaclass_MoveL_SendGoal):
    from ur_ros_rtde_msgs.action._move_l import MoveL_SendGoal_Request as Request
    from ur_ros_rtde_msgs.action._move_l import MoveL_SendGoal_Response as Response
...
class MoveL_GetResult_Response(metaclass=Metaclass_MoveL_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'ur_ros_rtde_msgs/MoveL_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ur_ros_rtde_msgs', 'action'], 'MoveL_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ur_ros_rtde_msgs.action._move_l import MoveL_Result
...
class Metaclass_MoveL_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.MoveL_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveL_GetResult(metaclass=Metaclass_MoveL_GetResult):
    from ur_ros_rtde_msgs.action._move_l import MoveL_GetResult_Request as Request
    from ur_ros_rtde_msgs.action._move_l import MoveL_GetResult_Response as Response
...
class Metaclass_MoveL_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur_ros_rtde_msgs.action.MoveL_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveL_FeedbackMessage(metaclass=Metaclass_MoveL_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'ur_ros_rtde_msgs/MoveL_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ur_ros_rtde_msgs', 'action'], 'MoveL_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from ur_ros_rtde_msgs.action._move_l import MoveL_Feedback
...
class MoveL(metaclass=Metaclass_MoveL):
    ...
    from ur_ros_rtde_msgs.action._move_l import MoveL_Goal as Goal
    # The result message defined in the action definition.
    from ur_ros_rtde_msgs.action._move_l import MoveL_Result as Result
    # The feedback message defined in the action definition.
    from ur_ros_rtde_msgs.action._move_l import MoveL_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from ur_ros_rtde_msgs.action._move_l import MoveL_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from ur_ros_rtde_msgs.action._move_l import MoveL_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from ur_ros_rtde_msgs.action._move_l import MoveL_FeedbackMessage as FeedbackMessage
