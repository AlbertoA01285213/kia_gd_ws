...
#ifndef UR_ROS_RTDE_MSGS__SRV__DETAIL__START_DATA_RECORDING__FUNCTIONS_H_
#define UR_ROS_RTDE_MSGS__SRV__DETAIL__START_DATA_RECORDING__FUNCTIONS_H_
...
/// Initialize srv/StartDataRecording message.
/**
...
/// Finalize srv/StartDataRecording message.
/**
...
/// Create srv/StartDataRecording message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur_ros_rtde_msgs__srv__StartDataRecording_Request__init().
...
/// Destroy srv/StartDataRecording message.
/**
 * It calls
 * ur_ros_rtde_msgs__srv__StartDataRecording_Request__fini()
...
/// Check for srv/StartDataRecording message equality.
/**
...
/// Copy a srv/StartDataRecording message.
/**
...
/// Initialize array of srv/StartDataRecording messages.
/**
...
/// Finalize array of srv/StartDataRecording messages.
/**
 * It calls
 * ur_ros_rtde_msgs__srv__StartDataRecording_Request__fini()
...
/// Create array of srv/StartDataRecording messages.
/**
 * It allocates the memory for the array and calls
 * ur_ros_rtde_msgs__srv__StartDataRecording_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/StartDataRecording messages.
/**
 * It calls
 * ur_ros_rtde_msgs__srv__StartDataRecording_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/StartDataRecording message array equality.
/**
...
/// Copy an array of srv/StartDataRecording messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur_ros_rtde_msgs__srv__StartDataRecording_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_ros_rtde_msgs
...
/**
 * It calls
 * ur_ros_rtde_msgs__srv__StartDataRecording_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_ros_rtde_msgs
...
/**
 * It allocates the memory for the array and calls
 * ur_ros_rtde_msgs__srv__StartDataRecording_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_ros_rtde_msgs
...
/**
 * It calls
 * ur_ros_rtde_msgs__srv__StartDataRecording_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UR_ROS_RTDE_MSGS__SRV__DETAIL__START_DATA_RECORDING__FUNCTIONS_H_
