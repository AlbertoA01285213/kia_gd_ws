...
#include "ur_ros_rtde_msgs/action/detail/execute_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ur_ros_rtde_msgs::action::ExecuteTrajectory_Goal & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.joint_speed_limits;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_ros_rtde_msgs::action::ExecuteTrajectory_Goal & ros_message)
{
  // Member: trajectory
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: joint_speed_limits
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.joint_speed_limits[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_ros_rtde_msgs::action::ExecuteTrajectory_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_ros_rtde_msgs::action::ExecuteTrajectory_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ur_ros_rtde_msgs::action::ExecuteTrajectory_Goal *>(
    untyped_ros_message);
...
{
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, action, ExecuteTrajectory_Goal)() {
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ur_ros_rtde_msgs
cdr_serialize(
  const ur_ros_rtde_msgs::action::ExecuteTrajectory_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_ros_rtde_msgs::action::ExecuteTrajectory_Result & ros_message)
{
  // Member: result
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs::action::ExecuteTrajectory_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_ros_rtde_msgs::action::ExecuteTrajectory_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ur_ros_rtde_msgs::action::ExecuteTrajectory_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, action, ExecuteTrajectory_Result)() {
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ur_ros_rtde_msgs
cdr_serialize(
  const ur_ros_rtde_msgs::action::ExecuteTrajectory_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_ros_rtde_msgs::action::ExecuteTrajectory_Feedback & ros_message)
{
  // Member: reached_waypoint
  cdr >> ros_message.reached_waypoint;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs::action::ExecuteTrajectory_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_ros_rtde_msgs::action::ExecuteTrajectory_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ur_ros_rtde_msgs::action::ExecuteTrajectory_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, action, ExecuteTrajectory_Feedback)() {
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_Feedback__handle;
}
...
// functions for ur_ros_rtde_msgs::action::ExecuteTrajectory_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ur_ros_rtde_msgs
cdr_serialize(
  const ur_ros_rtde_msgs::action::ExecuteTrajectory_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_ros_rtde_msgs::action::ExecuteTrajectory_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_ExecuteTrajectory_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs::action::ExecuteTrajectory_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_ros_rtde_msgs::action::ExecuteTrajectory_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ur_ros_rtde_msgs::action::ExecuteTrajectory_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, action, ExecuteTrajectory_SendGoal_Request)() {
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ur_ros_rtde_msgs
cdr_serialize(
  const ur_ros_rtde_msgs::action::ExecuteTrajectory_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_ros_rtde_msgs::action::ExecuteTrajectory_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs::action::ExecuteTrajectory_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_ros_rtde_msgs::action::ExecuteTrajectory_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ur_ros_rtde_msgs::action::ExecuteTrajectory_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, action, ExecuteTrajectory_SendGoal_Response)() {
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_SendGoal_Response__handle;
}
...
{
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, action, ExecuteTrajectory_SendGoal)() {
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ur_ros_rtde_msgs
cdr_serialize(
  const ur_ros_rtde_msgs::action::ExecuteTrajectory_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_ros_rtde_msgs::action::ExecuteTrajectory_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs::action::ExecuteTrajectory_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_ros_rtde_msgs::action::ExecuteTrajectory_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ur_ros_rtde_msgs::action::ExecuteTrajectory_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, action, ExecuteTrajectory_GetResult_Request)() {
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for ur_ros_rtde_msgs::action::ExecuteTrajectory_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ur_ros_rtde_msgs
cdr_serialize(
  const ur_ros_rtde_msgs::action::ExecuteTrajectory_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_ros_rtde_msgs::action::ExecuteTrajectory_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_ExecuteTrajectory_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs::action::ExecuteTrajectory_GetResult_Response;
    is_plain =
      (
      offsetof(DataType, result) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const ur_ros_rtde_msgs::action::ExecuteTrajectory_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ur_ros_rtde_msgs::action::ExecuteTrajectory_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, action, ExecuteTrajectory_GetResult_Response)() {
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_GetResult_Response__handle;
}
...
{
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, action, ExecuteTrajectory_GetResult)() {
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_GetResult__handle;
}
...
// functions for ur_ros_rtde_msgs::action::ExecuteTrajectory_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ur_ros_rtde_msgs
cdr_serialize(
  const ur_ros_rtde_msgs::action::ExecuteTrajectory_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_ros_rtde_msgs::action::ExecuteTrajectory_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_ExecuteTrajectory_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs::action::ExecuteTrajectory_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_ros_rtde_msgs::action::ExecuteTrajectory_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ur_ros_rtde_msgs::action::ExecuteTrajectory_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, action, ExecuteTrajectory_FeedbackMessage)() {
  return &ur_ros_rtde_msgs::action::typesupport_fastrtps_cpp::_ExecuteTrajectory_FeedbackMessage__handle;
}
