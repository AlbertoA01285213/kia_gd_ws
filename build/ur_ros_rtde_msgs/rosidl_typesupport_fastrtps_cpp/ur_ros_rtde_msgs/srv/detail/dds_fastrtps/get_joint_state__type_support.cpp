...
#include "ur_ros_rtde_msgs/srv/detail/get_joint_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ur_ros_rtde_msgs::srv::GetJointState_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_ros_rtde_msgs::srv::GetJointState_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_ros_rtde_msgs::srv::GetJointState_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_ros_rtde_msgs::srv::GetJointState_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ur_ros_rtde_msgs::srv::GetJointState_Request *>(
    untyped_ros_message);
...
{
  return &ur_ros_rtde_msgs::srv::typesupport_fastrtps_cpp::_GetJointState_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, srv, GetJointState_Request)() {
  return &ur_ros_rtde_msgs::srv::typesupport_fastrtps_cpp::_GetJointState_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ur_ros_rtde_msgs
cdr_serialize(
  const ur_ros_rtde_msgs::srv::GetJointState_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_ros_rtde_msgs::srv::GetJointState_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs::srv::GetJointState_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_ros_rtde_msgs::srv::GetJointState_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ur_ros_rtde_msgs::srv::GetJointState_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ur_ros_rtde_msgs::srv::typesupport_fastrtps_cpp::_GetJointState_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, srv, GetJointState_Response)() {
  return &ur_ros_rtde_msgs::srv::typesupport_fastrtps_cpp::_GetJointState_Response__handle;
}
...
{
  return &ur_ros_rtde_msgs::srv::typesupport_fastrtps_cpp::_GetJointState__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_ros_rtde_msgs, srv, GetJointState)() {
  return &ur_ros_rtde_msgs::srv::typesupport_fastrtps_cpp::_GetJointState__handle;
}
