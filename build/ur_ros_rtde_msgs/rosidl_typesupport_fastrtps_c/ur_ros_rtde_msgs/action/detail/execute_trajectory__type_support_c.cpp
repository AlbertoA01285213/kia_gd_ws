...
#include "ur_ros_rtde_msgs/action/detail/execute_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // joint_speed_limits
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // joint_speed_limits
#include "ur_ros_rtde_msgs/msg/detail/vector__functions.h"  // trajectory
...
using _ExecuteTrajectory_Goal__ros_msg_type = ur_ros_rtde_msgs__action__ExecuteTrajectory_Goal;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: speed_percentage
  {
    cdr << ros_message->speed_percentage;
  }

  // Field name: joint_speed_limits
  {
    size_t size = ros_message->joint_speed_limits.size;
    auto array_ptr = ros_message->joint_speed_limits.data;
    cdr << static_cast<uint32_t>(size);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: trajectory
  {
    ...
    if (ros_message->trajectory.data) {
      ur_ros_rtde_msgs__msg__Vector__Sequence__fini(&ros_message->trajectory);
    }
    if (!ur_ros_rtde_msgs__msg__Vector__Sequence__init(&ros_message->trajectory, size)) {
  ...
  // Field name: joint_speed_limits
  {
    ...
    if (ros_message->joint_speed_limits.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->joint_speed_limits);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->joint_speed_limits, size)) {
      fprintf(stderr, "failed to create array for field 'joint_speed_limits'");
      return false;
    }
    auto array_ptr = ros_message->joint_speed_limits.data;
...
size_t get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_Goal__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_Goal__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name speed_percentage
  {
    size_t item_size = sizeof(ros_message->speed_percentage);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name joint_speed_limits
  {
    size_t array_size = ros_message->joint_speed_limits.size;
    auto array_ptr = ros_message->joint_speed_limits.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
...
static uint32_t _ExecuteTrajectory_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_ros_rtde_msgs__action__ExecuteTrajectory_Goal;
    is_plain =
      (
      offsetof(DataType, joint_speed_limits) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ExecuteTrajectory_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Goal(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_Goal)() {
...
using _ExecuteTrajectory_Result__ros_msg_type = ur_ros_rtde_msgs__action__ExecuteTrajectory_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_Result__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs__action__ExecuteTrajectory_Result;
    is_plain =
      (
...
static size_t _ExecuteTrajectory_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_Result)() {
...
using _ExecuteTrajectory_Feedback__ros_msg_type = ur_ros_rtde_msgs__action__ExecuteTrajectory_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_Feedback__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs__action__ExecuteTrajectory_Feedback;
    is_plain =
      (
...
static size_t _ExecuteTrajectory_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_Feedback)() {
...
// already included above
// #include "ur_ros_rtde_msgs/action/detail/execute_trajectory__functions.h"  // goal
...
using _ExecuteTrajectory_SendGoal_Request__ros_msg_type = ur_ros_rtde_msgs__action__ExecuteTrajectory_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs__action__ExecuteTrajectory_SendGoal_Request;
    is_plain =
      (
...
static size_t _ExecuteTrajectory_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_SendGoal_Request)() {
...
using _ExecuteTrajectory_SendGoal_Response__ros_msg_type = ur_ros_rtde_msgs__action__ExecuteTrajectory_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs__action__ExecuteTrajectory_SendGoal_Response;
    is_plain =
      (
...
static size_t _ExecuteTrajectory_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_SendGoal)() {
...
using _ExecuteTrajectory_GetResult_Request__ros_msg_type = ur_ros_rtde_msgs__action__ExecuteTrajectory_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_GetResult_Request__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs__action__ExecuteTrajectory_GetResult_Request;
    is_plain =
      (
...
static size_t _ExecuteTrajectory_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_GetResult_Request)() {
...
// already included above
// #include "ur_ros_rtde_msgs/action/detail/execute_trajectory__functions.h"  // result
...
using _ExecuteTrajectory_GetResult_Response__ros_msg_type = ur_ros_rtde_msgs__action__ExecuteTrajectory_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_GetResult_Response__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs__action__ExecuteTrajectory_GetResult_Response;
    is_plain =
      (
      offsetof(DataType, result) +
      last_member_size
...
static size_t _ExecuteTrajectory_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_GetResult)() {
...
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
// already included above
// #include "ur_ros_rtde_msgs/action/detail/execute_trajectory__functions.h"  // feedback
...
using _ExecuteTrajectory_FeedbackMessage__ros_msg_type = ur_ros_rtde_msgs__action__ExecuteTrajectory_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_ros_rtde_msgs__action__ExecuteTrajectory_FeedbackMessage;
    is_plain =
      (
...
static size_t _ExecuteTrajectory_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_ros_rtde_msgs__action__ExecuteTrajectory_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, action, ExecuteTrajectory_FeedbackMessage)() {
