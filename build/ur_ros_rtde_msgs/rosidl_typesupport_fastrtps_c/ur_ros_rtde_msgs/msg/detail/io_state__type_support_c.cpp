...
#include "ur_ros_rtde_msgs/msg/detail/io_state__rosidl_typesupport_fastrtps_c.h"
...
using _IOState__ros_msg_type = ur_ros_rtde_msgs__msg__IOState;
...
size_t get_serialized_size_ur_ros_rtde_msgs__msg__IOState(
  const void * untyped_ros_message,
...
static uint32_t _IOState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_ros_rtde_msgs__msg__IOState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_ros_rtde_msgs
size_t max_serialized_size_ur_ros_rtde_msgs__msg__IOState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_ros_rtde_msgs__msg__IOState;
    is_plain =
      (
...
static size_t _IOState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_ros_rtde_msgs__msg__IOState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, msg, IOState)() {
