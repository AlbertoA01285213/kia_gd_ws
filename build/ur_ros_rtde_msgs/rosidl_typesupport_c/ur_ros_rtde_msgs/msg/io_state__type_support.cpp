...
#include "ur_ros_rtde_msgs/msg/detail/io_state__type_support.h"
...
static const _IOState_type_support_symbol_names_t _IOState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_ros_rtde_msgs, msg, IOState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ur_ros_rtde_msgs, msg, IOState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ur_ros_rtde_msgs, msg, IOState)() {
  return &::ur_ros_rtde_msgs::msg::rosidl_typesupport_c::IOState_message_type_support_handle;
}
